...
public class Prober extends DNSStateTask {
    ...
    protected DNSOutgoing buildOutgoingForDNS(DNSOutgoing out) throws IOException {
        ...
        newOut = this.addQuestion(newOut, DNSQuestion.newQuestion(this.getDns().getLocalHost().getName(), DNSRecordType.TYPE_ANY, DNSRecordClass.CLASS_IN, DNSRecordClass.NOT_UNIQUE));
